...
/**
 * Create MYSQL_DATABASE if missing and apply server/schema.sql (CREATE TABLE IF NOT EXISTS …).
 * Lets `npm run server:dev` work without manually running mysql CLI on Windows.
 */
